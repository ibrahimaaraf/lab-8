	...
	<div class="content_area">
		...
		<table>
			<tr>
				...
				<td><input type="password" placeholder="Enter CurrentPassword" value="<?php echo $epass; ?>" /></td>
				
			</tr>
			<tr>
				<td><b>New password :</b></td>
				<td><input type="password" placeholder="Enter New Password"/></td>
				
			</tr>
			
			<tr>
				<td><b>Retype New Password :</b></td>
				<td><input type="password" placeholder="Re-enter the Password"/></td>
